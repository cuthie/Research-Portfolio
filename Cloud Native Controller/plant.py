...
async def main(duration, timeout, h):
    ...
    for i in range(N):
        ...
        try:
            ...
            # Request controllers
            pending_tasks.add(asyncio.create_task(send_request('130.235.202.230:32360', n, '/ctrl', 10)))
    ...
    plt.plot(Real_pos, color='b', label='Real Position')
    # plt.title('real pos')
    # plt.xlabel('Time Slot')
    # plt.ylabel('Real position of the ball (meter)')

    # plt.figure()
    # plt.plot(Real_speed)
    # plt.title('real speed')
    # plt.xlabel('Time Slot')
    # plt.ylabel('Real speed of the ball (m/s)')

    # plt.figure()
    # plt.plot(Real_ang)
    # plt.title('real angle')
    # plt.xlabel('Time Slot')
    # plt.ylabel('Real angle of the ball (radian)')

    # plt.figure()
    plt.plot(Cloud_pos, color='m', label='Cloud Position')
    # plt.title('cloud pos')
    # plt.xlabel('Time Slot')
    # plt.ylabel(' Cloud position of the ball (meter)')

    # plt.figure()
    # plt.plot(Cloud_speed)
    # plt.title('cloud speed')
    # plt.xlabel('Time Slot')
    # plt.ylabel('Cloud speed of the ball (m/s)')

    # plt.figure()
    # plt.plot(Cloud_ang)
    # plt.title('cloud angle')
    # plt.xlabel('Time Slot')
    # plt.ylabel('Cloud angle of the ball (radian)')
